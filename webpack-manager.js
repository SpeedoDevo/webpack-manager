...
module.exports = function(instance) {
  ...
  manager.watchOptions.aggregateTimeout = createSetter(manager, "watchOptions.aggregateTimeout");
  manager.watchOptions.poll = createSetter(manager, "watchOptions.poll");
  ...
  resolve.root = createSetter(manager, "resolve.root", true);
  ...
  resolveLoader.root = createSetter(manager, "resolveLoader.root", true);
